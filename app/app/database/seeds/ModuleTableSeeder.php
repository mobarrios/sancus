	...
	public function run()
	{
		...
		$modules = array(
						...
						*/
						...
						array(
							"name" => Config::get('constants.MEDICALINSURANCEPLAN_MODULE_NAME'),
							"path" => Config::get('constants.MEDICALINSURANCEPLAN_MODULE_PATH')
						),
						array(
						...
						array(
							"name" => Config::get('constants.PAYMENTOPTION_MODULE_NAME'),
							"path" => Config::get('constants.PAYMENTOPTION_MODULE_PATH')
						),
					);
